...
<body>
    ...
    <form method="get" action="checkout.php">
        <div class="container d-flex justify-content-center align-items-center align-content-center mx-auto">
            <input class="d-flex justify-content-center align-items-center align-content-center" type="number" name="a" required="" placeholder="Aantal mensen" style="margin:20px;height:100px;width:300px;font-size:42px;padding:10px;">
            <input type="number" required="" name="u" placeholder="Klantnummer" style="margin:20px;width:300px;height:100px;font-size:42px;padding:10px;"></div>
        <div class="container d-flex justify-content-center align-items-center align-content-center mx-auto">
            <input class="d-flex justify-content-center align-items-center align-content-center" type="date" name="dv" required="" placeholder="Vanaf - Datum" style="margin:20px;height:100px;width:300px;font-size:30px;padding:10px;">
            <input type="date" required="" name="dt" placeholder="Tot - Datum" style="margin:20px;width:300px;height:100px;font-size:30px;padding:10px;"></div>
        <div class="container d-flex justify-content-center mx-auto"><a target="_blank" href="upload.php">
                <h4>Upload foto</h4>
            </a></div>
